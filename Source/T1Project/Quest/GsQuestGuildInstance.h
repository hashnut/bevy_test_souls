 ...
 *
 */
class T1PROJECT_API FGsQuestGuildInstance final : public FGsQuestInstance
{
...
private:
	const FGsSchemaQuestGuildStory*				_schemaQuestStory;				// 퀘스트 길드 스토리 스키마
...
public:
	...
	virtual bool IsShowHudUI() const override;
	// 텔레포트 비용
