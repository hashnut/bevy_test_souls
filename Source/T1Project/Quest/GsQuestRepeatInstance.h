 ...
 * 
 */
class T1PROJECT_API FGsQuestRepeatInstance final : public FGsQuestInstance
{
...
private:
	TSharedPtr<FGsQuestRepeatStoryTableCache>	_questRepeatTableCache;
	const FGsSchemaQuestRepeatStory*			_schemaQuestStory;				// 퀘스트 반복 스토리 스키마
...
public:
	RepeatStoryType GetRepeatStoryType() const;
};
