 ...
 *
 */
class T1PROJECT_API FGsStateLobbyHiveCheckMaintenance : public FGsContentsLobbyBase
{
...
public:
	FGsStateLobbyHiveCheckMaintenance();
	virtual ~FGsStateLobbyHiveCheckMaintenance();
