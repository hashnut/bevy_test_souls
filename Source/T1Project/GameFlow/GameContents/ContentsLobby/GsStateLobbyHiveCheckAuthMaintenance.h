 ...
 *
 */
class T1PROJECT_API FGsStateLobbyHiveCheckAuthMaintenance : public FGsContentsLobbyBase
{
...
public:
	FGsStateLobbyHiveCheckAuthMaintenance();
	virtual ~FGsStateLobbyHiveCheckAuthMaintenance();
