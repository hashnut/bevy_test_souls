...
UGsUIIconBase* UGsWrapBoxIconSelector::CreateIcon(EGsIconType InIconType, uint8 InIconKey)
{
#if WITH_EDITORONLY_DATA
	if (IsDesignTime())
	{
...
UGsUIIconBase* UGsWrapBoxIconSelector::CreateIcon()
{
	return CreateIcon(_iconType, _iconKey);
}

UPanelWidget* UGsWrapBoxIconSelector::GetPanel()
{
	return this;
}

void UGsWrapBoxIconSelector::WarmUp(int32 InWarmUpIconCount)
{
