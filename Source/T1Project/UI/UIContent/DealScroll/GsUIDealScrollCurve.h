...
#include "GsUIDealScrollCurve.generated.h"

/**
 * 커브를 사용하는 딜스크롤(화면에 자주 출력되는 경우 이것을 사용)
 */
UCLASS()
class T1PROJECT_API UGsUIDealScrollCurve : public UGsUIDealScrollBase
{
	GENERATED_BODY()

protected:
	UPROPERTY(BlueprintReadOnly, Category = "GsUI", meta = (BindWidget))		
	class UTextBlock* _textBlockValue;
...
protected:
	...
	virtual void SetValueText(const FText& InText) override;
	virtual void SetValueString(const FString& InValue, bool bIsNumber) override;
};
