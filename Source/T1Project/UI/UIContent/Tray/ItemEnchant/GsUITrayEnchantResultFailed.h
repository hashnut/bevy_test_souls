...
#include "GsUITrayEnchantResultFailed.generated.h"
 ...
 */
UCLASS()
class T1PROJECT_API UGsUITrayEnchantResultFailed : public UGsUITray
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(BlueprintReadOnly, Category = "GsUI", meta = (BindWidget))
	UTextBlock* _itemBeforeShieldCountText;
	UPROPERTY(BlueprintReadOnly, Category = "GsUI", meta = (BindWidget))
	UTextBlock* _itemAftereShieldCountText;
