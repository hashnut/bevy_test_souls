...
#include "GsUIBMShopLargeBanner.generated.h"
 ...
 */
UCLASS()
class T1PROJECT_API UGsUIBMShopLargeBanner : public UUserWidget
...
protected:
	...
	USizeBox* _sizebox;
	UPROPERTY(BlueprintReadOnly, Category = "GsUI", meta = (BindWidget))
	UGsUICurrencySlot* _priceSlot;
	UPROPERTY(BlueprintReadOnly, Category = "GsUI", meta = (BindWidget))
	UGsUICurrencySlot* _mileageSlot;
	UPROPERTY(BlueprintReadOnly, Category = "GsUI", meta = (BindWidget))
