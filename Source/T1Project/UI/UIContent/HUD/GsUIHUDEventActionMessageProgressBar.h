...
#include "GsUIHUDEventActionMessageProgressBar.generated.h"

UCLASS(meta = (DisableNativeTick))
class T1PROJECT_API UGsUIHUDEventActionMessageProgressBar : public UGsUIHUD
{
	GENERATED_BODY()
