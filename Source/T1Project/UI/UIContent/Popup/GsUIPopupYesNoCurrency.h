...
#include "GsUIPopupYesNoCurrency.generated.h"
 ...
 */
UCLASS()
class T1PROJECT_API UGsUIPopupYesNoCurrency : public UGsUIPopup
{
	GENERATED_BODY()
...
protected:
	...
	UTextBlock* _textBlockNo;

	UPROPERTY(BlueprintReadOnly, Category = "GsUI", meta = (BindWidget))
	UGsUICurrencyButton* _btnYes;
...
public:
	...
	void SetData(const FText& InContent, const FText& InYesButton, TFunction<void(bool)> InCallback = nullptr);
