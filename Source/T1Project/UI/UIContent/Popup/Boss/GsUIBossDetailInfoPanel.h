...
#include "GsUIBossDetailInfoPanel.generated.h"
...
UCLASS()
class T1PROJECT_API UGsUIBossDetailInfoPanel : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	void SetBossInfo(EGsBossTab inBossTab, const FGsSchemaFieldBossData* inBossInfo, const FGsSchemaFieldBossData* inMutant, bool inShowMutant = false, time_t inTime = 0);
	UFUNCTION()
...
public:
	...
	void SetParents(TWeakObjectPtr<UGsUIWindowBossInfo> inParents);
