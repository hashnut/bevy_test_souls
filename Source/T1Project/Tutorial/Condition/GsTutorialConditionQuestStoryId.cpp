...
#include "GsTutorialConditionQuestStoryId.h"
...
void FGsTutorialConditionQuestStoryId::Initialize(const FGsSchemaTutorial* InTable)
{
...
bool FGsTutorialConditionQuestStoryId::CheckCondition(const IGsMessageParam* InParam)
{
...
bool FGsTutorialConditionQuestStoryId::IsValidToStart()
{
