...
#include "GsTutorialActionNpcShopSelectPotionList.h"
...
bool FGsTutorialActionNpcShopSelectPotionList::OnStart()
{
	...
	_window->OnTutorialListItem.BindRaw(this, &FGsTutorialActionNpcShopSelectPotionList::OnTutorialListItem);
...
void FGsTutorialActionNpcShopSelectPotionList::OnEnd(bool bInSendMessage)
{
	if (_window.IsValid())
	{
...
void FGsTutorialActionNpcShopSelectPotionList::OnTutorialListItem(UWidget* InWidget)
{
	if (nullptr == _actionUITable)
	{
		return;
