 ...
 * - int[n] : passivityId
 */
class T1PROJECT_API FGsEffectTextParseSkillPassivityList final : public FGsEffectTextParseBase
{
public:
	explicit FGsEffectTextParseSkillPassivityList(class FGsEffectTextParser* InParser)
		: FGsEffectTextParseBase(InParser)
	{
	}
	virtual ~FGsEffectTextParseSkillPassivityList() {}

public:
	virtual EGsEffectTextParseType GetParseType() const override { return EGsEffectTextParseType::SKILL_PASSIVITY_LIST; }	
	...
	virtual bool SetData(const FGsSchemaSkillSet* InData, OUT FGsSchemaEffectTextData& OutData) override;
};
