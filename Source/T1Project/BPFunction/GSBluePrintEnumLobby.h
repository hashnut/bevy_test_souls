...
enum class EGS_LOBBY_Enum : uint8
{
	...
	GS_LOBBY_END_TITLE	UMETA(DisplayName = "GS_LOBBY_END_TITLE"),
	GS_LOBBY_BACKTO_SERVER_SELECT UMETA(DisplayName = "LOBBY_BACKTO_SERVER_SELECT"),
	GS_LOBBY_BACKTO_CHARACTER_CREATE UMETA(DisplayName = "LOBBY_BACKTO_CHARACTER_CREATE"),
	...
	GS_LOBBY_ENTER_CHARACTER_CUSTOMIZING UMETA(DisplayName = "LOBBY_ENTER_CHARACTER_CUSTOMIZING")
