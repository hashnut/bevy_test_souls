...
#include "../../../TerritoryEditor/Util/GsTerritoryEditorFileUtil.h"
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(EditorPostBuildRegisterServerLevelDirectorysToNeverCook, TEXT("Raon.EditorPostBuild.3 Register Server Level Directorys To NeverCook")
	, EAutomationTestFlags::EditorContext | EAutomationTestFlags::MediumPriorityAndAbove | EAutomationTestFlags::EngineFilter)

bool EditorPostBuildRegisterServerLevelDirectorysToNeverCook::RunTest(const FString& Parameters)
{
