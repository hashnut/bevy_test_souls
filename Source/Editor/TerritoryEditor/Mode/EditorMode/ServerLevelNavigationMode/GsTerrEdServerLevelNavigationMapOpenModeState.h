...
class TERRITORYEDITOR_API FGsTerrEdServerLevelNavigationMapOpenModeState : public FGsTerrEdModeStateBase
{
private:
	class FGsTerrEdEditorModeServerLevelNavigationModeState* _parents;

public:
	FGsTerrEdServerLevelNavigationMapOpenModeState();
	virtual ~FGsTerrEdServerLevelNavigationMapOpenModeState();
