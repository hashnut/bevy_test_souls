...
class TERRITORYEDITOR_API FGsTerrEdServerLevelNavigationMapIdleModeState : public FGsTerrEdModeStateBase
{
private:
	class FGsTerrEdEditorModeServerLevelNavigationModeState* _parents;

public:
	FGsTerrEdServerLevelNavigationMapIdleModeState();
	virtual ~FGsTerrEdServerLevelNavigationMapIdleModeState();
