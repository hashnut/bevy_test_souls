...
#include "GsTerritoryLevelEditorEx.h"

//UE4
#include "Editor/Blutility/Classes/GlobalEditorUtilityBase.h"
#include "ActorActionUtility.h"
#include "AssetRegistryModule.h"
#include "Editor/Blutility/Private/BlutilityMenuExtensions.h"
...
FGsTerritoryLevelEditorEx::FGsTerritoryLevelEditorEx()
{
}
...
//Referenced FBlutilityLevelEditorExtensions_Impl::OnExtendLevelEditorActorContextMenu

void FGsTerritoryLevelEditorEx::GetBlutilityClasses(TArray<FAssetData>& OutAssets, const FName& InClassName)
{
	...
	//Filter.ClassNames.Add(FName(TEXT("EditorUtilityBlueprint")));
...
class SFunctionParamDialog : public SCompoundWidget
{
	...
	void CreateTestDialog(const FArguments& InArgs, TWeakPtr<SWindow> InParentWindow, TSharedRef<FStructOnScope> InStructOnScope, TSharedRef<IStructureDetailsView> StructureDetailsView)
	{
		
	}

	void CreateNpcDialog(const FArguments& InArgs, TWeakPtr<SWindow> InParentWindow, TSharedRef<FStructOnScope> InStructOnScope, TSharedRef<IStructureDetailsView> StructureDetailsView)
	{	
		//ChildSlot
		//	[
		//		SNew(SVerticalBox)
		...
		//			[
		//				SNew(SVerticalBox)
		//				+SVerticalBox::Slot().HAlign(EHorizontalAlignment::HAlign_Fill)
		//				.AutoHeight()						
		//				[
		//					//StructureDetailsView->GetWidget().ToSharedRef()
	...
	void CreateDialog(const FArguments& InArgs, TWeakPtr<SWindow> InParentWindow, TSharedRef<FStructOnScope> InStructOnScope, TSharedRef<IStructureDetailsView> StructureDetailsView)
	{
		//ChildSlot
		//	[
		//		SNew(SVerticalBox)
		...
		//	[
		//		SNew(SVerticalBox)
		//		+ SVerticalBox::Slot().VAlign(EVerticalAlignment::VAlign_Fill).HAlign(EHorizontalAlignment::HAlign_Fill)
		//	[
		//		SNew(SButton)
		//		.ButtonStyle(FEditorStyle::Get(), "FlatButton")
		//	.ForegroundColor(FLinearColor::White)
	...
	//	//StructureDetailsView->GetWidget()->setv

	//	StructureDetailsView->GetDetailsView()->ForceRefresh();			

	//	//TSharedPtr<IPropertyHandle> targetIDHandler = InStructOnScope->GetStruct()->FindPropertyByName("TargetId");

	//	//TArray<FPropertyPath> paths = StructureDetailsView->GetDetailsView()->GetPropertiesInOrderDisplayed();

	//	//paths

	//	CreateNpcDialog(InArgs, InParentWindow, InStructOnScope, StructureDetailsView);

	//	//CreateNpcDialog(ChildSlot, InParentWindow, InStructOnScope);
	//	//ChildSlot
	//	//[
	//	//		SNew(SVerticalBox)
	//	//		+ SVerticalBox::Slot()
...
//FBlutilityMenuExtensions::CreateBlutilityActionsMenu
//void FGsTerritoryLevelEditorEx::CreateBlutilityActionsMenu(
//	FMenuBuilder& MenuBuilder, TArray<UDEPRECATED_GlobalEditorUtilityBase*> Utils
//)
//{
...
//	//		LOCTEXT("TerratoryActorAction", "Terratory Actions"),
//	//		LOCTEXT("TerratoryActorActionTooltip", "Scripted actions available for the selected actors"),
...
//
//	//						/*FPropertyChangedEvent testEvent;
//
//	//						testEvent.ChangeType = EPropertyChangeType::ValueSet;
//	//						testEvent.*/
//
//
//	//						//TempObject->PostEditChangeProperty(testEvent);
//
...
//	//							
//	//							if (UProperty* test = FuncParams->GetStruct()->FindPropertyByName("TargetID"))
//	//							{																		
//	//								if (UIntProperty* intProperty = Cast<UIntProperty>(test))
//	//								{																				
//	//									int32 temp = intProperty->GetPropertyValue(FuncParams->GetStruct()->Children);
//
//	//									UE_LOG(LogTemp, Log, TEXT("Propperty value : %d"), temp);
//
//	//									//intProperty->SetPropertyValue(FuncParams->GetStruct(), 10000);
//	//								}
//	//							}																								
//
