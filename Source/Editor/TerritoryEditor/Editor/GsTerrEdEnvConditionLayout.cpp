...
#include "GsTerrEdEnvConditionLayout.h"
...
TSharedRef<IPropertyTypeCustomization> FGsTerrEdEnvConditionLayout::MakeInstance()
{
	return MakeShareable(new FGsTerrEdEnvConditionLayout());
}

void FGsTerrEdEnvConditionLayout::CustomizeHeader(TSharedRef<IPropertyHandle> inPropertyHandle
...
void FGsTerrEdEnvConditionLayout::CustomizeChildren(TSharedRef<IPropertyHandle> inPropertyHandle, IDetailChildrenBuilder& inChildBuilder, IPropertyTypeCustomizationUtils& inCustomizationUtils)
{
	//get property handle			
	InvalidQuestIDInfos();
...
//general ==========================================================================================================================================================
TSharedRef<SWidget> FGsTerrEdEnvConditionLayout::OnGenerateQuestIDWidget(TSharedPtr<FString> inSelect)
{
	return SNew(STextBlock).Text(FText::FromString(*inSelect)).Font(IDetailLayoutBuilder::GetDetailFont());
}

void FGsTerrEdEnvConditionLayout::InvalidQuestIDInfos()
{
...
//start ==========================================================================================================================================================
void FGsTerrEdEnvConditionLayout::ChangedStartQuestID(FGsTerrEdSearchableComboBox& inComboBox, FString& inQuestId, TSharedPtr<FString> inNewSelection, ESelectInfo::Type inSelectInfo)
{
...
void FGsTerrEdEnvConditionLayout::InitQuestID(FGsTerrEdSearchableComboBox& inComboBox, FString& inQuestId)
{
...
void FGsTerrEdEnvConditionLayout::CreateQuestIDSearchComboBox(FGsTerrEdSearchableComboBox& inComboBox
, FString& inQuestId
...
, TFunction<FText(void)> inGetEvent)
{
	...
	.ValueContent()
		...
		.OnGenerateWidget(this, &FGsTerrEdEnvConditionLayout::OnGenerateQuestIDWidget)
...
FText FGsTerrEdEnvConditionLayout::GetSelectedQuestIDText(FString& inText) const
{
	return FText::FromString(inText);
}

//int64 FGsTerrEdEnvConditionLayout::GetSelectedQuestID() const
//{
//	FString value = _questId;
//	TArray<FString> valueParses;
//	value.ParseIntoArray(valueParses, TEXT("-"), true);
//	if (valueParses.Num() == 0)
//	{
...
//	}
//
//	return FCString::Strtoi64(*valueParses[0], NULL, 10);
//}
