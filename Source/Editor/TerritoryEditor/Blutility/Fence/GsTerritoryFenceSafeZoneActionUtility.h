...
#include "GsTerritoryFenceSafeZoneActionUtility.generated.h"

/**
 * 
 */
UCLASS()
class TERRITORYEDITOR_API UGsTerritoryFenceSafeZoneActionUtility : public UGsTerritoryFenceBaseActionUtility
{
	GENERATED_BODY()
