...
#include "GsTerritoryFenceArenaReady.h"
#include "Util/GsTerritoryZoneShapeUtil.h"

void AGsTerritoryFenceArenaReady::InitArenaReadyFence(const FText& inName, FGsSchemaSoundResDataRow inSound)
{
	_name = inName;
	_sound = inSound;
...
void AGsTerritoryFenceArenaReady::InvalidDestription()
{
	SetTerritoryTitleText(TEXT("FenceArenaReady"));
...
void AGsTerritoryFenceArenaReady::SetSound(const FGsSchemaSoundResDataRow& inSound)
{
	_sound = inSound;
...
void AGsTerritoryFenceArenaReady::Export(OUT FGsSchemaMapTerritoryInfo& outTerritoryInfo, OUT FGsSchemaFenceElement& outFenceElement)
{
	//safe zone
...
void AGsTerritoryFenceArenaReady::Import(const FGsSchemaMapTerritoryInfo& inTerritoryInfo, const FGsSchemaFenceElement& inFence)
{	
