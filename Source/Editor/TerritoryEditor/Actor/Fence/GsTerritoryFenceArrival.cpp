...
#include "GsTerritoryFenceArrival.h"
#include "Util/GsTerritoryZoneShapeUtil.h"

void AGsTerritoryFenceArrival::InitArrivalFence(const FText& inName, FGsSchemaSoundResDataRow inSound)
{
	_name = inName;
	_sound = inSound;
...
void AGsTerritoryFenceArrival::InvalidDestription()
{
	SetTerritoryTitleText(TEXT("FenceArrival"));
...
void AGsTerritoryFenceArrival::SetSound(const FGsSchemaSoundResDataRow& inSound)
{
	_sound = inSound;
...
void AGsTerritoryFenceArrival::Export(OUT FGsSchemaMapTerritoryInfo& outTerritoryInfo, OUT FGsSchemaFenceElement& outFenceElement)
{
	//safe zone
...
void AGsTerritoryFenceArrival::Import(const FGsSchemaMapTerritoryInfo& inTerritoryInfo, const FGsSchemaFenceElement& inFence)
{	
