...
#include "GsTerritoryFenceTown.h"
#include "Util/GsTerritoryZoneShapeUtil.h"

void AGsTerritoryFenceTown::InitTownFence(FText inName, const FGsSchemaSoundResDataRow& inSound)
{
	_name = inName;
	_sound = inSound;
...
void AGsTerritoryFenceTown::InvalidDestription()
{
	SetTerritoryTitleText(TEXT("TownFence"));
...
void AGsTerritoryFenceTown::SetSound(const FGsSchemaSoundResDataRow& inSound)
{
	_sound = inSound;
...
void AGsTerritoryFenceTown::Export(OUT FGsSchemaMapTerritoryInfo& outTerritoryInfo, OUT FGsSchemaFenceElement& outFenceElement)
{
	//town
...
void AGsTerritoryFenceTown::Import(const FGsSchemaMapTerritoryInfo& inTerritoryInfo
