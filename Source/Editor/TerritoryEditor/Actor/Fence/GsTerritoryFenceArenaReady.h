...
#include "GsTerritoryFenceArenaReady.generated.h"



UCLASS()
class TERRITORYEDITOR_API AGsTerritoryFenceArenaReady : public AGsTerritoryFenceBase
{
	GENERATED_BODY()
...
public:
	void InitArenaReadyFence(const FText& inName, FGsSchemaSoundResDataRow inSound);

public:
	virtual void InvalidDestription() override;
	void SetSound(const FGsSchemaSoundResDataRow& inSound);
	virtual TerritoryType GetFenceType() override { return TerritoryType::ARENA_READY; }
