...
// Class for registering and managing Skill Asset in UI (Slate)
...
class SSkillAssetListItem;
class SSkillAssetTileItem;
struct FSkillAssetViewItem;

template <typename ItemType> class SListView;

DECLARE_DELEGATE_ThreeParams( FOnRenameBegin, const TSharedPtr<FSkillAssetViewItem>& /*AssetItem*/, const FString& /*OriginalName*/, const FSlateRect& /*MessageAnchor*/)
DECLARE_DELEGATE_FourParams( FOnRenameCommit, const TSharedPtr<FSkillAssetViewItem>& /*AssetItem*/, const FString& /*NewName*/, const FSlateRect& /*MessageAnchor*/, ETextCommit::Type /*CommitType*/ )
DECLARE_DELEGATE_RetVal_FourParams( bool, FOnVerifyRenameCommit, const TSharedPtr<FSkillAssetViewItem>& /*AssetItem*/, const FText& /*NewName*/, const FSlateRect& /*MessageAnchor*/, FText& /*OutErrorMessage*/)
DECLARE_DELEGATE_OneParam( FOnItemDestroyed, const TSharedPtr<FSkillAssetViewItem>& /*AssetItem*/);

class SSkillAssetListItem;
class SSkillAssetTileItem;

namespace FSkillAssetViewModeUtils
{
	FReply OnViewModeKeyDown( const TSet< TSharedPtr<FSkillAssetViewItem> >& SelectedItems, const FKeyEvent& InKeyEvent );
}

struct FSkillAssetViewItemHelper
{
public:
	static TSharedRef<SWidget> CreateListItemContents(SSkillAssetListItem* const InListItem, const TSharedRef<SWidget>& InThumbnail, FName& OutItemShadowBorder);
	//static TSharedRef<SWidget> CreateTileItemContents(SSkillAssetTileItem* const InTileItem, const TSharedRef<SWidget>& InThumbnail, FName& OutItemShadowBorder);
...
class SSkillAssetListView : public SListView<TSharedPtr<FSkillAssetViewItem>>
{
public:
	virtual bool SupportsKeyboardFocus() const override { return true; }
	virtual FReply OnKeyDown( const FGeometry& InGeometry, const FKeyEvent& InKeyEvent ) override;
...
class SSkillAssetViewItem : public SCompoundWidget
{
...
public:
	...
	SLATE_BEGIN_ARGS(SSkillAssetViewItem)
		: _ShouldAllowToolTip(true)
		, _ThumbnailEditMode(false)
		{}

		/** Data for the asset this item represents */
		SLATE_ARGUMENT( TSharedPtr<FSkillAssetViewItem>, AssetItem )
...
protected:
	...
	TSharedPtr<FSkillAssetViewItem> AssetItem;
...
class SSkillAssetListItem : public SSkillAssetViewItem
{
	friend struct FSkillAssetViewItemHelper;

public:
	SLATE_BEGIN_ARGS( SSkillAssetListItem )
		: _ThumbnailPadding(0)
