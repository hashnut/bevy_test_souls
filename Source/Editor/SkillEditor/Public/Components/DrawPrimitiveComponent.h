...
#include "DrawPrimitiveComponent.generated.h"
...
struct SKILLEDITOR_API FPrimitiveDrawProxy
{
	GENERATED_BODY()
...
class SKILLEDITOR_API UDrawPrimitiveComponent : public UPrimitiveComponent
{
	GENERATED_BODY()
...
public:
	UDrawPrimitiveComponent(const FObjectInitializer& ObjectInitializer);
