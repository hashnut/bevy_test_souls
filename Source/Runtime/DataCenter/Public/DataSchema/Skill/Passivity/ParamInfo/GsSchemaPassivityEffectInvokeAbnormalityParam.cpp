...
FGsSchemaPassivityEffectInvokeAbnormalityParam::FGsSchemaPassivityEffectInvokeAbnormalityParam()
{
	SET_ALL_PROPERTIES_FROM_ASSETSCHEMA_DEFAULT(FGsSchemaPassivityEffectInvokeAbnormalityParam)
